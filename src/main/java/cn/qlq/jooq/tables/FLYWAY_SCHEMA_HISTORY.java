...
public class FLYWAY_SCHEMA_HISTORY extends TableImpl<FlywaySchemaHistoryRecord> {

    private static final long serialVersionUID = 2082697485;

    /**
     * The reference instance of <code>test1.flyway_schema_history</code>
     */
    public static final FLYWAY_SCHEMA_HISTORY FLYWAY_SCHEMA_HISTORY = new FLYWAY_SCHEMA_HISTORY();
    ...
    /**
     * The column <code>test1.flyway_schema_history.installed_rank</code>.
     */
    ...
    /**
     * The column <code>test1.flyway_schema_history.version</code>.
     */
    ...
    /**
     * The column <code>test1.flyway_schema_history.description</code>.
     */
    ...
    /**
     * The column <code>test1.flyway_schema_history.type</code>.
     */
    ...
    /**
     * The column <code>test1.flyway_schema_history.script</code>.
     */
    ...
    /**
     * The column <code>test1.flyway_schema_history.checksum</code>.
     */
    ...
    /**
     * The column <code>test1.flyway_schema_history.installed_by</code>.
     */
    ...
    /**
     * The column <code>test1.flyway_schema_history.installed_on</code>.
     */
    ...
    /**
     * The column <code>test1.flyway_schema_history.execution_time</code>.
     */
    ...
    /**
     * The column <code>test1.flyway_schema_history.success</code>.
     */
    ...
    /**
     * Create a <code>test1.flyway_schema_history</code> table reference
     */
    ...
    /**
     * Create an aliased <code>test1.flyway_schema_history</code> table reference
     */
    public FLYWAY_SCHEMA_HISTORY(String alias) {
     ...
     * Create an aliased <code>test1.flyway_schema_history</code> table reference
     */
    public FLYWAY_SCHEMA_HISTORY(Name alias) {
        this(alias, FLYWAY_SCHEMA_HISTORY);
    }

    private FLYWAY_SCHEMA_HISTORY(Name alias, Table<FlywaySchemaHistoryRecord> aliased) {
        this(alias, aliased, null);
    }

    private FLYWAY_SCHEMA_HISTORY(Name alias, Table<FlywaySchemaHistoryRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""));
    }

    public <O extends Record> FLYWAY_SCHEMA_HISTORY(Table<O> child, ForeignKey<O, FlywaySchemaHistoryRecord> key) {
    ...
    @Override
    public FLYWAY_SCHEMA_HISTORY as(String alias) {
        return new FLYWAY_SCHEMA_HISTORY(DSL.name(alias), this);
    }

    @Override
    public FLYWAY_SCHEMA_HISTORY as(Name alias) {
        return new FLYWAY_SCHEMA_HISTORY(alias, this);
    }
     ...
     */
    @Override
    public FLYWAY_SCHEMA_HISTORY rename(String name) {
        return new FLYWAY_SCHEMA_HISTORY(DSL.name(name), null);
    }
     ...
     */
    @Override
    public FLYWAY_SCHEMA_HISTORY rename(Name name) {
        return new FLYWAY_SCHEMA_HISTORY(name, null);
    }
